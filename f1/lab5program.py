...
print("percentage of income category in complete housing database(20640) ranging from 1 to 5 ")
print(housing["income_cat"].value_counts()/len(housing))

print(housing["income_cat"].value_counts())
    
print("percentage of income category in stratified sampling in training data set ranging from 1 to 5")
print(strat_train_set["income_cat"].value_counts())

print(strat_train_set["income_cat"].value_counts()/len(strat_train_set))
print(" percentage of income category in stratified sampling in testing data set ranging from 1 to 5 ")
